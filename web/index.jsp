<%-- 
    Document   : index
    Created on : 17/05/2019, 05:11:22 PM
    Author     : gemelo
--%>
...
<html>
    ...
    <body>
        ...
        <ul id="opciones" class="dropdown-content">
            ...
            <li><a href="TarjetasGuardadas.jsp">Tarjetas Guardadas</a></li>
            <li class="divider"></li>
                ...
                <div class="col s12 m4">
                    <div class="card Medium">
                        <div class="card-image">
                            ...
                            <div class="card-panel white-text   blue-grey darken-4">Titulo de la tarjeta</div>
                            <a class="btn-floating halfway-fab waves-effect waves-light btn  blue darken-1 modal-trigger tooltipped"
                               href="#modal" data-position="bottom" data-tooltip="agregar nueva tarjeta"><i class="material-icons">add</i></a>
                        </div>
                ...
                <div class="col s12 m4">
                    <div class="card Medium">
                        ...
                        <div class="card-action center">
                            ...
                            <a class="waves-effect waves-light btn   teal accent-4">editar</a>
                            <a class="waves-effect waves-light btn    red darken-1" onclick="return confirm('desea eliminar esta tarjeta?')">eliminar</a>
